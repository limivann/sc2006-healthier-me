	...
	return (
		<Layout style={{ flex: 1 }}>
			...
			<ScrollView contentContainerStyle={styles.contentContainer}>
				...
				<Text style={styles.shortDescription}>Organic Greens, Salads</Text>
				<Text style={styles.longDescription}>
					DIY vegetarian salad bowl restaurants. Among the options are pasta,
					potato salad, and olive fried rice
				</Text>
				...
				<Layout style={styles.statusContainer}>
					...
					<Text style={styles.statusOppositeText}>Closes 8:00 pm</Text>
				</Layout>
